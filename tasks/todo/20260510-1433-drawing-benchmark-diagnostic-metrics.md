...
保存先: `tasks/todo/20260510-1433-drawing-benchmark-diagnostic-metrics.md`
...
- [ ] AC1: 新規サブスコアが summary と Markdown report に出る。
- [ ] AC2: 入力がない metric は `not_applicable` として扱われ、0 点扱いされない。
- [ ] AC3: architecture-drawing-qarag の failure taxonomy が retrieval / OCR / grounding / reasoning / abstention に分けて確認できる。
- [ ] AC4: 既存 benchmark suite の summary 互換性を壊さない。
