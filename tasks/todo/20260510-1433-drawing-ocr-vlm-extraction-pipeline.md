...
保存先: `tasks/todo/20260510-1433-drawing-ocr-vlm-extraction-pipeline.md`
...
- [ ] AC1: extraction result に source method、bbox、confidence、parser version が残る。
- [ ] AC2: crop region 単位の OCR / VLM-OCR を呼べる。
- [ ] AC3: VLM-OCR が使えない場合に架空値で埋めず、failure reason が残る。
- [ ] AC4: titleblock / legend / dimension extraction が同じ artifact を利用できる。
