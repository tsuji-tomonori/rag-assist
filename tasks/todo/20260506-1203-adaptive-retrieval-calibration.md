...
- monitoring / verification: calibration 手順、dataset 条件、rollback、false answer / false refusal / latency の確認方法を `docs/4_運用_OPS/21_監視_MONITORING/OPS_MONITORING_001.md` に追記する。
