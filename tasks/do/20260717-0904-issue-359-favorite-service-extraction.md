...
- [ ] AC7: 日本語 draft stacked PR、`semver:patch`、AC/self-review comment を完了する。
...
実装 commit と draft stacked PR 作成後、日本語 AC/self-review comment、task done/report lifecycle commit、final-head CI、Issue #359 進捗 comment、CLEAN/upstream 一致を確認する。merge / deploy / release は実施しない。
