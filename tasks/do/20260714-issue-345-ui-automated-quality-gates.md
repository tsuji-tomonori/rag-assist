...
- `git diff --check`: pass。
- 未検証: 300 pixels超の意図的な visual failure fixture とartifact取得、browser matrixのowner最終判断、実 browser 200% / 400% zoom、representative screen reader、touch / real-device。
