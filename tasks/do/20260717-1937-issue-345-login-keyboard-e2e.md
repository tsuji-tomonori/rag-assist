...
- [ ] selected/full validation、Draft PR、semver、AC/self-review、report/task done、final-head CI、Issue #345 進捗まで完遂する。
...
- validations: selected/full/final-head CIが成功し、blocking self-review指摘がない。
- lifecycle: Issue #345進捗、clean/upstream一致まで確認する。
