...
- `pre-commit run --files .github/workflows/memorag-benchmark-run.yml memorag-bedrock-mvp/docs/OPERATIONS.md tasks/do/20260509-1043-benchmark-api-action-loop.md`: pass。task md を `tasks/done/` に移動する前に実行。
