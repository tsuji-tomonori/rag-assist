...
- [x] AC10: report、目的別 commit、Draft stacked PR、`semver:patch`、日本語 body / AC / self-review / verification、two-head CI、Issue #358 progress を完遂する。
- [x] AC11: local HEAD / upstream / remote 一致と clean worktree を確認し、対象外・未実施事項を記録する。
...
- Draft PR: https://github.com/tsuji-tomonori/rag-assist/pull/441（stacked base、Draft、`semver:patch`、日本語 body / AC / self-review / verification）。
- implementation-head CI: https://github.com/tsuji-tomonori/rag-assist/actions/runs/29605782792 が success。
- report-head CI: https://github.com/tsuji-tomonori/rag-assist/actions/runs/29606486992 が success。
- Issue progress: https://github.com/tsuji-tomonori/rag-assist/issues/358#issuecomment-5006649922 を投稿し、Issue は open のまま維持した。
- lifecycle 前 readback: `7f5b600d87742a0fa3ee2840de6ed0b33d916e2f` で local HEAD / upstream / remote が一致し、worktree は clean だった。task 完了 commit 後にも final-head readback を実施して PR comment に残す。
