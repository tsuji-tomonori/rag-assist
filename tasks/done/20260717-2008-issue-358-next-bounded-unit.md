...
- 保存先: `tasks/done/20260717-2008-issue-358-next-bounded-unit.md`
- 状態: done
- タスク種別: 機能追加
...
- [x] AC9: work report、目的別commit、Draft stacked PR、semver:patch、日本語PR body/AC/self-reviewを完遂する。
...
AC10 のうち Draft PR、日本語AC/self-review、implementation-head remote CI success、task done/report は確認済み。task done commit後にしか存在しない final head のCI、Issue進捗、clean/upstream/remote一致は、PR #430 の最終top-level commentを完了証跡とする。

## 実装・検証証跡

- 実装commit: `248b65600bbdb05dea0044bd6d99e17b27939b9c`
- Draft stacked PR: https://github.com/tsuji-tomonori/rag-assist/pull/430
- base: `codex/issue-358-fr086-quarantine-redrive-operation`（PR #426 final head）
- label: `semver:patch`
- 受け入れ条件comment: https://github.com/tsuji-tomonori/rag-assist/pull/430#issuecomment-5003035532
- self-review comment: https://github.com/tsuji-tomonori/rag-assist/pull/430#issuecomment-5003035747
- 実装head CI: https://github.com/tsuji-tomonori/rag-assist/actions/runs/29578627587 (`success`)
