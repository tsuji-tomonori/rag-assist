...
- [x] Web 画面一覧を route path、画面コンポーネント、推定ラベル付きで生成できる。
- [x] Web コンポーネント一覧をファイル、export、使用 JSX 要素付きで生成できる。
- [x] ボタン、リンク、フォーム、クリック/送信ハンドラなど主要 UI 操作要素を抽出できる。
- [x] 日本語 Markdown と JSON の両方を生成できる。
- [x] CI または package script で生成結果の最新性を確認できる。
