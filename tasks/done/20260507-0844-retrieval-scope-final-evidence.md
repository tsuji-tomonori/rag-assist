...
保存先: `tasks/done/20260507-0844-retrieval-scope-final-evidence.md`
...
- [x] benchmark retrieval が seed corpus scope を検索前に適用する。
- [x] tenant / workspace / ACL 境界を弱めない。
- [x] raw retrieval と final evidence の出力が区別できる。
- [x] metric がどちらを評価しているか docs / report から読める。
- [x] 関連 benchmark / API tests と `git diff --check` が pass する、または未実施理由を明記する。
