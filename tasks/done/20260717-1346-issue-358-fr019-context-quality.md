...
- [x] selected/full validation、Draft stacked PR、AC/self-review、task/report を完遂する。final-head CI と Issue #358 進捗は lifecycle commit 後の外部 gate として確認する。
...
- 受け入れ条件: https://github.com/tsuji-tomonori/rag-assist/pull/411#issuecomment-4999258693
- セルフレビュー: https://github.com/tsuji-tomonori/rag-assist/pull/411#issuecomment-4999259586
- implementation-head CI: success（8分9秒）
