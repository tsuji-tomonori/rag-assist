...
| 変更履歴（続き） | 2026-08-18 文書画面の検索・filter value・file table・selected row・detail dialogをChromium AX tree契約へ追加 |
