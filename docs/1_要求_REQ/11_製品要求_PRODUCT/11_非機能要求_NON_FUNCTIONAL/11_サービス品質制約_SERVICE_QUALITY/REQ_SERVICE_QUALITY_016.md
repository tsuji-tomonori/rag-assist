...
- Firefox／WebKitの自動証跡はlogin / chatのsemantic contractと主要keyboard journeyに限定する。representative screen reader、実 browser の 200%/400% zoom、touch／real device、Firefox／WebKit native accessibility treeのengine固有debug出力、非対象画面のbrowser evidenceを代替しない。
