...
| 変更履歴（続き） | 2026-08-18 文書画面の検索・filter value・file table・detail dialog・disclosure expandedをChromium AX tree契約へ追加し、選択行のDOM `aria-selected`も検証。2026-08-19 文書画面の検索・絞り込み・文書選択・detail dialog focus trap／Escape／trigger復帰をChromium／Firefox／WebKitのkeyboard-only required gateへ追加。2026-08-20 管理者設定のoverview／section遷移とユーザー検索・絞り込みをChromium／Firefox／WebKitのkeyboard-only required gateへ追加。2026-08-21 管理者設定のworkspace／section／ユーザー管理のname・role・valueをChromium AX tree required gateへ追加。2026-08-22 チャットのtext contrast、3px focus indicator contrast、permission stateの非色依存cueをChromium required gateへ追加。2026-08-23 担当者対応のtext contrast、3px focus indicator contrast、permission stateの非色依存cueをChromium required gateへ追加。2026-08-26 個人設定のname・role・valueと変更後のvisible polite statusをFirefox／WebKitのARIA snapshot／DOM state required gateへ追加 |
