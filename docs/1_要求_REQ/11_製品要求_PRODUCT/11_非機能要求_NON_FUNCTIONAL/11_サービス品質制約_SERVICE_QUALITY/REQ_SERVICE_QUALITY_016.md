...
- Firefox／WebKitの自動証跡はloginと主要keyboard journeyに限定する。representative screen reader、実 browser の 200%/400% zoom、touch／real device、Firefox／WebKitのaccessibility tree、非対象画面のbrowser evidenceを代替しない。
