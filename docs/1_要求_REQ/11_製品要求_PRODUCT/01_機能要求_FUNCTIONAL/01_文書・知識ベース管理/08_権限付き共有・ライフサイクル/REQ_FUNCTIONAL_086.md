...
| folder move・delete、document move・delete、administrative principal transfer | open | outbox producerとdomain recovery stateは存在するが、production workerへauthoritative resolverが未登録 |
