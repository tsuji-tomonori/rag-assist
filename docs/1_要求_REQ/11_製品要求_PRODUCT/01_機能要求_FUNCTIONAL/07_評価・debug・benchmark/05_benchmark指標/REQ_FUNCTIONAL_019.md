...
| 受け入れ基準 | `AC-FR019-001` から `AC-FR019-013` |
| 優先度 | S |
| 安定性 | Medium |
| 変更履歴 | 2026-05-01 初版 / 2026-05-02 LLM judge 指標を追加 / 2026-05-05 Markdown report の日本語説明列を追加 / 2026-07-17 false refusal、faithfulness/context relevance、run/artifact completeness の evidence 境界を追加 |
