...
| GAP-RD-021 | CloudFront/CORS/SPA relative API/PKCE/WebSocket ticket/default endpoint無効化はsource/CDKでaccepted targetへ同期した。実AWSのDNS/certificate、REST/101、default endpoint 403、security header/失敗メトリクス evidenceが未完で、`TC-003` 全体は未達。 | confirmed | `tasks/done/20260717-1045-issue-358-tc003-direct-endpoint.md` |
