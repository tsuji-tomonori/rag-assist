...
| 管理者設定 | admin | / (client-state) | [管理](web-features/admin.md) | AdminWorkspace | canSeeAdminSettings | チャットへ戻る、管理操作履歴をエクスポート、コスト summary をエクスポート、更新、管理対象ユーザー作成、メール ほか 21 件 | confirmed |
...
- 主要操作: チャットへ戻る、管理操作履歴をエクスポート、コスト summary をエクスポート、更新、管理対象ユーザー作成、メール、表示名、任意、初期ロール、role ほか 17 件
