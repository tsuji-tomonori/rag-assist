...
| ドキュメント | documents | / (client-state) | [ドキュメント](web-features/documents.md) | DocumentWorkspace | canManageDocuments | 管理者設定へ戻る、共有フォルダ / 選択してください / 共有 group / 追加: / 削除: / 保存、共有フォルダ / 選択してください、shareGroupId \|\| selectedGroupId、選択してください、共有 group ほか 70 件 | confirmed |
...
- 主要操作: 管理者設定へ戻る、共有フォルダ / 選択してください / 共有 group / 追加: / 削除: / 保存、共有フォルダ / 選択してください、shareGroupId || selectedGroupId、選択してください、共有 group、group をカンマ区切りで入力、既存共有をすべて削除することを確認しました、保存、移動先: / 保存 ほか 66 件
