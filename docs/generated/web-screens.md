...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| チャット | chat | / (query-state) | [チャット](web-features/chat.md) | ChatView | - | standard-user, answer-editor, operator, system-admin<br>JOB-UI-CHAT: 質問し、回答・回答不能・根拠・確認質問・人手対応への状態を追う | FR-003: AC-FR003-002, AC-FR003-003, AC-FR003-004<br>FR-004: AC-FR004-002, AC-FR004-003<br>FR-005: AC-FR005-002, AC-FR005-003<br>FR-021: AC-FR021-006, AC-FR021-007<br>FR-029: AC-FR029-001<br>FR-042: AC-FR042-001, AC-FR042-004<br>FR-043: AC-FR043-001, AC-FR043-003, AC-FR043-004<br>FR-094: AC-FR094-002, AC-FR094-004<br>FR-095: AC-FR095-001, AC-FR095-003, AC-FR095-004<br>FR-096: AC-FR096-003, AC-FR096-004<br>SQ-016: AC-SQ016-002, AC-SQ016-007 | E2E-VIEW-CHAT-001 (implemented) | implemented | 自分で入力、質問入力、質問、ファイルをアップロード、資料を添付、モデル / Nova Lite v1 / Claude 3.5 Sonnet / Claude 3 Haiku ほか 24 件 | confirmed |
...
- 要件・AC: `FR-003` (`AC-FR003-002`, `AC-FR003-003`, `AC-FR003-004`) / `FR-004` (`AC-FR004-002`, `AC-FR004-003`) / `FR-005` (`AC-FR005-002`, `AC-FR005-003`) / `FR-021` (`AC-FR021-006`, `AC-FR021-007`) / `FR-029` (`AC-FR029-001`) / `FR-042` (`AC-FR042-001`, `AC-FR042-004`) / `FR-043` (`AC-FR043-001`, `AC-FR043-003`, `AC-FR043-004`) / `FR-094` (`AC-FR094-002`, `AC-FR094-004`) / `FR-095` (`AC-FR095-001`, `AC-FR095-003`, `AC-FR095-004`) / `FR-096` (`AC-FR096-003`, `AC-FR096-004`) / `SQ-016` (`AC-SQ016-002`, `AC-SQ016-007`)
