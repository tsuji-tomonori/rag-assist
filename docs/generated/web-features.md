...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 管理 | admin | 管理者向けのユーザー、ロール、利用状況、コスト、alias review / publish を扱う領域です。 | admin | 8 | 35 | 「チャットへ戻る」を実行するボタン。<br>「管理操作履歴をエクスポート」を実行するボタン。<br>「コスト summary をエクスポート」を実行するボタン。 ほか 25 件 | [admin.md](web-features/admin.md) |
