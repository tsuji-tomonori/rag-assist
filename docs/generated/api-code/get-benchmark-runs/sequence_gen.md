...
| 4 | `MemoRagService.listBenchmarkRuns` | Store | `this.deps.benchmarkRunStore` に対して list を実行する。 | `this.deps.benchmarkRunStore.list(authoritativeActorTenantId(actor))` | `apps/api/src/rag/memorag-service.ts:4381 (MemoRagService.listBenchmarkRuns)` |
