...
| ---: | --- | --- | --- | --- | --- |
| 1 | `POST /documents/{documentId}/source-governance/restrict handler` | Auth | 認証済み利用者を request context から取得する。 | `c.get("user")` | `apps/api/src/routes/document-routes.ts:563 (POST /documents/{documentId}/source-governance/restrict handler)` |
| 2 | `POST /documents/{documentId}/source-governance/restrict handler` | Auth | "rag:source:approve" permission を必須条件として確認する。 | `requirePermission(user, "rag:source:approve")` | `apps/api/src/routes/document-routes.ts:564 (POST /documents/{documentId}/source-governance/restrict handler)` |
| 3 | `POST /documents/{documentId}/source-governance/restrict handler` | Validation | schema 検証済みの path parameter を取得する。 | `validParam<{ documentId: string }>(c)` | `apps/api/src/routes/document-routes.ts:565 (POST /documents/{documentId}/source-governance/restrict handler)` |
| 4 | `POST /documents/{documentId}/source-governance/restrict handler` | Validation | schema 検証済みの JSON request body を取得する。 | `validJson<RestrictSourceGovernanceInput>(c)` | `apps/api/src/routes/document-routes.ts:566 (POST /documents/{documentId}/source-governance/restrict handler)` |
| 5 | `POST /documents/{documentId}/source-governance/restrict handler` | Service | service の restrict source governance 処理を呼び出す。 | `service.restrictSourceGovernance(user, documentId, body)` | `apps/api/src/routes/document-routes.ts:568 (POST /documents/{documentId}/source-governance/restrict handler)` |
| 6 | `MemoRagService.restrictSourceGovernance` | Service | service の get manifest 処理を呼び出す。 | `this.getManifest(documentId, authoritativeActorTenantId(actor))` | `apps/api/src/rag/memorag-service.ts:550 (MemoRagService.restrictSourceGovernance)` |
...
| 8 | `MemoRagService.restrictSourceGovernance` | Service | service の source governance approval service 処理を呼び出す。 | `this.sourceGovernanceApprovalService()` | `apps/api/src/rag/memorag-service.ts:551 (MemoRagService.restrictSourceGovernance)` |
...
| 88 | `MemoRagService.restrictSourceGovernance` | Service | service の restrict 処理を呼び出す。 | `this.sourceGovernanceApprovalService().restrict(actor, manifest, input)` | `apps/api/src/rag/memorag-service.ts:551 (MemoRagService.restrictSourceGovernance)` |
...
| 98 | `POST /documents/{documentId}/source-governance/restrict handler` | HTTP/SSE | HTTP 200 で JSON response を返す。 | `c.json(publicSourceGovernanceRecord(await service.restrictSourceGovernance(user, documentId, body)), 200)` | `apps/api/src/routes/document-routes.ts:568 (POST /documents/{documentId}/source-governance/restrict handler)` |
| 99 | `POST /documents/{documentId}/source-governance/restrict handler` | HTTP/SSE | HTTP 400 で JSON response を返す。 | `c.json({ error: error.message }, 400)` | `apps/api/src/routes/document-routes.ts:570 (POST /documents/{documentId}/source-governance/restrict handler)` |
| 100 | `POST /documents/{documentId}/source-governance/restrict handler` | HTTP/SSE | HTTP 409 で JSON response を返す。 | `c.json({ error: error.message }, 409)` | `apps/api/src/routes/document-routes.ts:572 (POST /documents/{documentId}/source-governance/restrict handler)` |
| 101 | `POST /documents/{documentId}/source-governance/restrict handler` | HTTP/SSE | HTTP 503 で JSON response を返す。 | `c.json({ error: error.message }, 503)` | `apps/api/src/routes/document-routes.ts:573 (POST /documents/{documentId}/source-governance/restrict handler)` |

## 分岐

| ID | Function | 条件 | 実装位置 |
| --- | --- | --- | --- |
| B001 | `POST /documents/{documentId}/source-governance/restrict handler` | 例外が発生した場合に catch 処理へ移る | `apps/api/src/routes/document-routes.ts:569 (POST /documents/{documentId}/source-governance/restrict handler)` |
| B002 | `POST /documents/{documentId}/source-governance/restrict handler` | `error` が `SourceGovernanceValidationError` の instance である | `apps/api/src/routes/document-routes.ts:570 (POST /documents/{documentId}/source-governance/restrict handler)` |
| B003 | `POST /documents/{documentId}/source-governance/restrict handler` | `error` が `SourceGovernanceDeniedError` の instance である | `apps/api/src/routes/document-routes.ts:571 (POST /documents/{documentId}/source-governance/restrict handler)` |
| B004 | `POST /documents/{documentId}/source-governance/restrict handler` | `error` が `SourceGovernanceConflictError` の instance である | `apps/api/src/routes/document-routes.ts:572 (POST /documents/{documentId}/source-governance/restrict handler)` |
| B005 | `POST /documents/{documentId}/source-governance/restrict handler` | `error` が `SourceGovernanceUnavailableError` の instance である | `apps/api/src/routes/document-routes.ts:573 (POST /documents/{documentId}/source-governance/restrict handler)` |
| B006 | `POST /documents/{documentId}/source-governance/restrict handler` | `error` が `Error` の instance である、かつ `error.message` が "ENOENT" を含む、または `error.message` が "NoSuchKey" を含む | `apps/api/src/routes/document-routes.ts:574 (POST /documents/{documentId}/source-governance/restrict handler)` |
