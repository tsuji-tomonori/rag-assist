...
| 6 | `MemoRagService.restrictSourceGovernance` | Service | service の get manifest 処理を呼び出す。 | `this.getManifest(documentId, authoritativeActorTenantId(actor))` | `apps/api/src/rag/memorag-service.ts:576 (MemoRagService.restrictSourceGovernance)` |
...
| 8 | `MemoRagService.restrictSourceGovernance` | Service | service の source governance approval service 処理を呼び出す。 | `this.sourceGovernanceApprovalService()` | `apps/api/src/rag/memorag-service.ts:577 (MemoRagService.restrictSourceGovernance)` |
...
| 88 | `MemoRagService.restrictSourceGovernance` | Service | service の restrict 処理を呼び出す。 | `this.sourceGovernanceApprovalService().restrict(actor, manifest, input)` | `apps/api/src/rag/memorag-service.ts:577 (MemoRagService.restrictSourceGovernance)` |
