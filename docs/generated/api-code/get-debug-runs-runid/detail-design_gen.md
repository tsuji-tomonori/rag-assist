...
| B003 | `MemoRagService.getDebugRun` | if | `key` が存在しない、または偽である | `!key` | `apps/api/src/rag/memorag-service.ts:2361 (MemoRagService.getDebugRun)` |
...
| 1 | `MemoRagService.getDebugRun` | get debug run の実装処理を担当する。 | `apps/api/src/rag/memorag-service.ts:2357 (MemoRagService.getDebugRun)` |
| 2 | `localTestActor` | local test actor の実装処理を担当する。 | `apps/api/src/rag/memorag-service.ts:6101 (localTestActor)` |
| 2 | `debugTraceTenantPrefix` | debug trace tenant prefix の実装処理を担当する。 | `apps/api/src/rag/memorag-service.ts:6115 (debugTraceTenantPrefix)` |
| 2 | `normalizeDebugTrace` | normalize debug trace の実装処理を担当する。 | `apps/api/src/rag/memorag-service.ts:6164 (normalizeDebugTrace)` |
