...
- 実装 route: `apps/api/src/routes/admin-routes.ts:191 (POST /admin/audit-log/export)`
...
補足:
- audit export は sanitize 済み JSON を署名付き URL として返し、credential や raw prompt は含めません。
