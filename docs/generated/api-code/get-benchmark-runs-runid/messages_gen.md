...
# GET /benchmark-runs/{runId} メッセージ仕様
...
| M006 | HTTP 実装応答 | `404` | Benchmark run not found | `run` が存在しない、または偽である | `apps/api/src/routes/benchmark-routes.ts:163 (GET /benchmark-runs/{runId} handler)` |
