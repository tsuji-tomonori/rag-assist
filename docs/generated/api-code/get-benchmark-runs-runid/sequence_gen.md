...
| 5 | `MemoRagService.getBenchmarkRun` | Service | service の get 処理を呼び出す。 | `this.benchmarkRunQueryService.get(actor, runId)` | `apps/api/src/rag/memorag-service.ts:4706 (MemoRagService.getBenchmarkRun)` |
