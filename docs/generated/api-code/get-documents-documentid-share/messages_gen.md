...
| M011 | 例外 | `-` | document tenant is missing, invalid, or conflicting | `tenantId` が存在しない、または偽である | `apps/api/src/documents/document-permission-service.ts:755 (requireManifestTenantId)` |
