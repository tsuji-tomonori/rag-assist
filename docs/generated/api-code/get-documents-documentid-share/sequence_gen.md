...
| 5 | `MemoRagService.getDocumentShareInfo` | Service | service の get manifest 処理を呼び出す。 | `this.getManifest(documentId, authoritativeActorTenantId(actor))` | `apps/api/src/rag/memorag-service.ts:1028 (MemoRagService.getDocumentShareInfo)` |
...
| B005 | `MemoRagService.getDocumentShareInfo` | can share document の判定結果が真ではない | `apps/api/src/rag/memorag-service.ts:1031 (MemoRagService.getDocumentShareInfo)` |
