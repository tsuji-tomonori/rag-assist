...
# POST /benchmark-runs/{runId}/cancel メッセージ仕様
...
| M006 | HTTP 実装応答 | `404` | Benchmark run not found | `run` が存在しない、または偽である | `apps/api/src/routes/benchmark-routes.ts:185 (POST /benchmark-runs/{runId}/cancel handler)` |
