...
| 5 | `MemoRagService.cancelBenchmarkRun` | Service | service の cancel 処理を呼び出す。 | `this.benchmarkRunCancellationService.cancel(actor, runId)` | `apps/api/src/rag/memorag-service.ts:4634 (MemoRagService.cancelBenchmarkRun)` |
