...
# POST /questions/{questionId}/resolve IF仕様

- 実装 route: `apps/api/src/routes/question-routes.ts:159 (POST /questions/{questionId}/resolve)`
...
補足:
- 問い合わせ作成者本人は answer:publish がなくても、回答済み問い合わせだけ解決できます。
