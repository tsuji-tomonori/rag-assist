...
| ---: | --- | --- | --- | --- | --- | --- |
| 1 | 参照 | `this.deps.documentGroupStore` | `list` | `this.deps.documentGroupStore` に対して list を実行する。 | `MemoRagService.updateDocumentGroupSharing` | `apps/api/src/rag/memorag-service.ts:1198 (MemoRagService.updateDocumentGroupSharing)` |
...
| 8 | 更新 | `this.deps.documentGroupStore` | `updateWithPathLocks` | `this.deps.documentGroupStore` に対して update with path locks を実行する。 | `MemoRagService.updateDocumentGroupSharing` | `apps/api/src/rag/memorag-service.ts:1228 (MemoRagService.updateDocumentGroupSharing)` |
| 9 | 更新 | `this.deps.documentGroupStore` | `updateWithPathLocks` | `this.deps.documentGroupStore` に対して update with path locks を実行する。 | `MemoRagService.updateDocumentGroupSharing` | `apps/api/src/rag/memorag-service.ts:1231 (MemoRagService.updateDocumentGroupSharing)` |
