...
| M006 | 例外 | `-` | BENCHMARK_BUCKET_NAME is not configured | `config.benchmarkBucketName` が存在しない、または偽である | `apps/api/src/rag/memorag-service.ts:4760 (MemoRagService.createBenchmarkArtifactDownloadUrl)` |
