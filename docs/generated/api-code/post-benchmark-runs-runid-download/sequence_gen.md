...
| 6 | `MemoRagService.createBenchmarkArtifactDownloadUrl` | Service | service の create download 処理を呼び出す。 | `this.benchmarkArtifactDownloadService.createDownload(actor, runId, artifact)` | `apps/api/src/rag/memorag-service.ts:4607 (MemoRagService.createBenchmarkArtifactDownloadUrl)` |
