...
# GET /documents/reindex-migrations Unit Test仕様
...
| Case | シナリオ | 期待観点 | 根拠 |
| --- | --- | --- | --- |
| TC001 | 正常系 | 再インデックス移行一覧を取得する が成功 response を返す。 | `apps/api/src/routes/document-routes.ts:1405 (GET /documents/reindex-migrations handler)` |
