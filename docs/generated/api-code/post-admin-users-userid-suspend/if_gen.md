...
- 実装 route: `apps/api/src/routes/admin-routes.ts:241 (POST /admin/users/{userId}/suspend)`
...
| `403` | 必要 permission (user:suspend) または条件付き permission を満たさない場合。 | `{"error":"Forbidden"}` |
