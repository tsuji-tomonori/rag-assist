...
| 5 | `MemoRagService.cutoverReindexMigration` | Store | `this` に対して load reindex migration ledger を実行する。 | `this.loadReindexMigrationLedger()` | `apps/api/src/rag/memorag-service.ts:734 (MemoRagService.cutoverReindexMigration)` |
| 6 | `MemoRagService.loadReindexMigrationLedger` | Store | `this.deps.objectStore` に対して get text を実行する。 | `this.deps.objectStore.getText(reindexMigrationLedgerKey)` | `apps/api/src/rag/memorag-service.ts:3801 (MemoRagService.loadReindexMigrationLedger)` |
| 7 | `MemoRagService.cutoverReindexMigration` | Store | `ledger` に対して find を実行する。 | `ledger.find((candidate) => candidate.migrationId === migrationId)` | `apps/api/src/rag/memorag-service.ts:735 (MemoRagService.cutoverReindexMigration)` |
| 8 | `MemoRagService.cutoverReindexMigration` | Store | `compensationStore` に対して get を実行する。 | `compensationStore.get(actorTenantId, migrationId, "cutover")` | `apps/api/src/rag/memorag-service.ts:740 (MemoRagService.cutoverReindexMigration)` |
...
| 11 | `MemoRagService.cutoverReindexMigration` | Service | service の get manifest 処理を呼び出す。 | `this.getManifest(migration.sourceDocumentId, actorTenantId)` | `apps/api/src/rag/memorag-service.ts:745 (MemoRagService.cutoverReindexMigration)` |
...
| 13 | `MemoRagService.currentReindexAuthorizationManifest` | Store | `this.deps.objectStore` に対して get text を実行する。 | `this.deps.objectStore.getText(migration.activePointerKey)` | `apps/api/src/rag/memorag-service.ts:3718 (MemoRagService.currentReindexAuthorizationManifest)` |
| 14 | `MemoRagService.cutoverReindexMigration` | Service | service の assert document manifest writable 処理を呼び出す。 | `this.assertDocumentManifestWritable(actor, authorizationManifest)` | `apps/api/src/rag/memorag-service.ts:749 (MemoRagService.cutoverReindexMigration)` |
...
| 25 | `MemoRagService.cutoverReindexMigration` | Service | service の assert document manifest writable 処理を呼び出す。 | `this.assertDocumentManifestWritable(currentActor, authorizationManifest)` | `apps/api/src/rag/memorag-service.ts:759 (MemoRagService.cutoverReindexMigration)` |
...
| 27 | `MemoRagService.cutoverReindexMigration` | Service | service の reconcile revoked cutover 処理を呼び出す。 | `this.reconcileRevokedCutover( migration, compensation, compensationStore )` | `apps/api/src/rag/memorag-service.ts:767 (MemoRagService.cutoverReindexMigration)` |
...
| 71 | `MemoRagService.reconcileRevokedCutover` | Store | `store` に対して mark compensated を実行する。 | `store.markCompensated( repair, reindexCompensationResult(rolledBack), new Date().toISOString() )` | `apps/api/src/rag/memorag-service.ts:3740 (MemoRagService.reconcileRevokedCutover)` |
...
| 74 | `MemoRagService.reconcileRevokedCutover` | Store | `store` に対して mark failed を実行する。 | `store.markFailed(repair, error, new Date().toISOString())` | `apps/api/src/rag/memorag-service.ts:3746 (MemoRagService.reconcileRevokedCutover)` |
| 75 | `MemoRagService.reconcileRevokedCutover` | Store | `this` に対して complete reindex compensation ledger を実行する。 | `this.completeReindexCompensationLedger(migration, repair)` | `apps/api/src/rag/memorag-service.ts:3750 (MemoRagService.reconcileRevokedCutover)` |
| 76 | `MemoRagService.completeReindexCompensationLedger` | Store | `this` に対して save reindex migration ledger を実行する。 | `this.saveReindexMigrationLedger([migration])` | `apps/api/src/rag/memorag-service.ts:3796 (MemoRagService.completeReindexCompensationLedger)` |
| 77 | `MemoRagService.saveReindexMigrationLedger` | Store | `this.deps.objectStore` に対して get text with version を実行する。 | `this.deps.objectStore.getTextWithVersion(reindexMigrationLedgerKey)` | `apps/api/src/rag/memorag-service.ts:3813 (MemoRagService.saveReindexMigrationLedger)` |
| 78 | `MemoRagService.saveReindexMigrationLedger` | Store | `this.deps.objectStore` に対して put text if version を実行する。 | `this.deps.objectStore.putTextIfVersion( reindexMigrationLedgerKey, JSON.stringify({ schemaVersion: 1, migrations }, null, 2), stored?.version, "application/json" )` | `apps/api/src/rag/memorag-service.ts:3824 (MemoRagService.saveReindexMigrationLedger)` |
| 79 | `MemoRagService.reconcileRevokedCutover` | Store | `store` に対して mark completed を実行する。 | `store.markCompleted(repair, new Date().toISOString())` | `apps/api/src/rag/memorag-service.ts:3751 (MemoRagService.reconcileRevokedCutover)` |
...
| 95 | `MemoRagService.cutoverReindexMigration` | Store | `compensationStore` に対して mark compensated を実行する。 | `compensationStore.markCompensated( compensation, reindexCompensationResult(rolledBack), new Date().toISOString() )` | `apps/api/src/rag/memorag-service.ts:803 (MemoRagService.cutoverReindexMigration)` |
| 96 | `MemoRagService.cutoverReindexMigration` | Store | `compensationStore` に対して mark failed を実行する。 | `compensationStore.markFailed(compensation, compensationError, new Date().toISOString())` | `apps/api/src/rag/memorag-service.ts:809 (MemoRagService.cutoverReindexMigration)` |
| 97 | `MemoRagService.cutoverReindexMigration` | Store | `this` に対して save reindex migration ledger を実行する。 | `this.saveReindexMigrationLedger([migration])` | `apps/api/src/rag/memorag-service.ts:813 (MemoRagService.cutoverReindexMigration)` |
| 98 | `MemoRagService.cutoverReindexMigration` | Service | service の get manifest 処理を呼び出す。 | `this.getManifest(migration.stagedDocumentId, authoritativeActorTenantId(actor))` | `apps/api/src/rag/memorag-service.ts:816 (MemoRagService.cutoverReindexMigration)` |
| 99 | `MemoRagService.cutoverReindexMigration` | Service | service の reput document vectors with lifecycle 処理を呼び出す。 | `this.reputDocumentVectorsWithLifecycle(staged, "active")` | `apps/api/src/rag/memorag-service.ts:819 (MemoRagService.cutoverReindexMigration)` |
...
| 102 | `MemoRagService.reputDocumentVectorsWithLifecycle` | Store | `this.deps.objectStore` に対して get text を実行する。 | `this.deps.objectStore.getText(manifest.sourceObjectKey)` | `apps/api/src/rag/memorag-service.ts:4022 (MemoRagService.reputDocumentVectorsWithLifecycle)` |
| 103 | `MemoRagService.loadMemoryCards` | Store | `this.deps.objectStore` に対して get text を実行する。 | `this.deps.objectStore.getText(manifest.memoryCardsObjectKey)` | `apps/api/src/rag/memorag-service.ts:4009 (MemoRagService.loadMemoryCards)` |
| 104 | `MemoRagService.createMemoryCards` | External | `textModel` へ generate を実行する。 | `textModel.generate( buildMemoryCardPrompt(input.fileName, input.text), llmOptions("memoryCard", input.modelId ?? config.defaultMemoryModelId) )` | `apps/api/src/rag/memorag-service.ts:5035 (MemoRagService.createMemoryCards)` |
...
| 110 | `MemoRagService.cutoverReindexMigration` | Service | service の mark manifest lifecycle 処理を呼び出す。 | `this.markManifestLifecycle(staged, "active", { activeDocumentId: staged.documentId })` | `apps/api/src/rag/memorag-service.ts:820 (MemoRagService.cutoverReindexMigration)` |
| 111 | `MemoRagService.markManifestLifecycle` | Store | `this.deps.objectStore` に対して put text を実行する。 | `this.deps.objectStore.putText(next.manifestObjectKey, JSON.stringify(next, null, 2), "application/json")` | `apps/api/src/rag/memorag-service.ts:4148 (MemoRagService.markManifestLifecycle)` |
| 112 | `MemoRagService.cutoverReindexMigration` | Service | service の mark manifest lifecycle 処理を呼び出す。 | `this.markManifestLifecycle(source, "superseded")` | `apps/api/src/rag/memorag-service.ts:821 (MemoRagService.cutoverReindexMigration)` |
| 113 | `MemoRagService.cutoverReindexMigration` | Store | `this` に対して restore failed cutover state を実行する。 | `this.restoreFailedCutoverState(source, staged)` | `apps/api/src/rag/memorag-service.ts:823 (MemoRagService.cutoverReindexMigration)` |
| 114 | `MemoRagService.cutoverReindexMigration` | Service | service の delete document vectors 処理を呼び出す。 | `this.deleteDocumentVectors(source)` | `apps/api/src/rag/memorag-service.ts:826 (MemoRagService.cutoverReindexMigration)` |
| 115 | `MemoRagService.deleteDocumentVectors` | Store | `this.deps.evidenceVectorStore` に対して delete を実行する。 | `this.deps.evidenceVectorStore.delete(manifest.evidenceVectorKeys ?? manifest.vectorKeys)` | `apps/api/src/rag/memorag-service.ts:4131 (MemoRagService.deleteDocumentVectors)` |
| 116 | `MemoRagService.deleteDocumentVectors` | Store | `this.deps.memoryVectorStore` に対して delete を実行する。 | `this.deps.memoryVectorStore.delete(manifest.memoryVectorKeys ?? manifest.vectorKeys)` | `apps/api/src/rag/memorag-service.ts:4132 (MemoRagService.deleteDocumentVectors)` |
| 117 | `MemoRagService.cutoverReindexMigration` | Store | `this` に対して restore failed cutover state を実行する。 | `this.restoreFailedCutoverState(source, staged)` | `apps/api/src/rag/memorag-service.ts:835 (MemoRagService.cutoverReindexMigration)` |
| 118 | `MemoRagService.cutoverReindexMigration` | Store | `this` に対して save reindex migration ledger を実行する。 | `this.saveReindexMigrationLedger([migration])` | `apps/api/src/rag/memorag-service.ts:838 (MemoRagService.cutoverReindexMigration)` |
...
| B005 | `MemoRagService.cutoverReindexMigration` | `migration` が存在しない、または偽である | `apps/api/src/rag/memorag-service.ts:736 (MemoRagService.cutoverReindexMigration)` |
| B006 | `MemoRagService.cutoverReindexMigration` | `migration.publicationRunId` が存在し、真である | `apps/api/src/rag/memorag-service.ts:739 (MemoRagService.cutoverReindexMigration)` |
| B007 | `MemoRagService.cutoverReindexMigration` | `migration.status` が `"staged"` と異なる、かつ 「`compensation` が存在し、真である、かつ `migration.status` が `"rolled_back"` と等しい」ではない | `apps/api/src/rag/memorag-service.ts:742 (MemoRagService.cutoverReindexMigration)` |
| B008 | `MemoRagService.cutoverReindexMigration` | `compensation` が存在し、真である | `apps/api/src/rag/memorag-service.ts:746 (MemoRagService.cutoverReindexMigration)` |
| B009 | `MemoRagService.cutoverReindexMigration` | `migration.publicationRunId` が存在し、真である | `apps/api/src/rag/memorag-service.ts:765 (MemoRagService.cutoverReindexMigration)` |
| B010 | `MemoRagService.cutoverReindexMigration` | `compensation` が存在し、真である | `apps/api/src/rag/memorag-service.ts:766 (MemoRagService.cutoverReindexMigration)` |
| B011 | `MemoRagService.cutoverReindexMigration` | 例外が発生した場合に catch 処理へ移る | `apps/api/src/rag/memorag-service.ts:789 (MemoRagService.cutoverReindexMigration)` |
| B012 | `MemoRagService.cutoverReindexMigration` | 例外が発生した場合に catch 処理へ移る | `apps/api/src/rag/memorag-service.ts:808 (MemoRagService.cutoverReindexMigration)` |
| B013 | `MemoRagService.cutoverReindexMigration` | 例外が発生した場合に catch 処理へ移る | `apps/api/src/rag/memorag-service.ts:822 (MemoRagService.cutoverReindexMigration)` |
| B014 | `MemoRagService.cutoverReindexMigration` | 例外が発生した場合に catch 処理へ移る | `apps/api/src/rag/memorag-service.ts:834 (MemoRagService.cutoverReindexMigration)` |
