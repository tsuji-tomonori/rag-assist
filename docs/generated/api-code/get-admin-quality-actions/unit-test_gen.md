...
# GET /admin/quality-actions Unit Test仕様
...
| Case | シナリオ | 期待観点 | 根拠 |
| --- | --- | --- | --- |
| TC001 | 正常系 | 文書品質 action card 一覧を取得する が成功 response を返す。 | `apps/api/src/routes/admin-routes.ts:612 (GET /admin/quality-actions handler)` |
