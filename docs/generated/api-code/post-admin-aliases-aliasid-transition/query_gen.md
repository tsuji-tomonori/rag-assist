...
| ---: | --- | --- | --- | --- | --- | --- |
| 1 | 参照 | `ledger.aliases` | `find` | `ledger.aliases` に対して find を実行する。 | `findTenantAlias` | `apps/api/src/rag/memorag-service.ts:5639 (findTenantAlias)` |
...
| 3 | 実行 | `this` | `mutateAliasLedger` | `this` に対して mutate alias ledger を実行する。 | `MemoRagService.transitionAliasToDraft` | `apps/api/src/rag/memorag-service.ts:1578 (MemoRagService.transitionAliasToDraft)` |
