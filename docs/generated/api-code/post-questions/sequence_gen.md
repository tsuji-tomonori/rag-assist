...
| B002 | `MemoRagService.createQuestion` | `input.assigneeUserId` が存在し、真である、または `input.assigneeGroupId` が存在し、真である | `apps/api/src/rag/memorag-service.ts:1458 (MemoRagService.createQuestion)` |
