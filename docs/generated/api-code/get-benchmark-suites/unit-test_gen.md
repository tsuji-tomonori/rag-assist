...
# GET /benchmark-suites Unit Test仕様
...
| Case | シナリオ | 期待観点 | 根拠 |
| --- | --- | --- | --- |
| TC001 | 正常系 | ベンチマーク suite 一覧を取得する が成功 response を返す。 | `apps/api/src/routes/benchmark-routes.ts:103 (GET /benchmark-suites handler)` |
