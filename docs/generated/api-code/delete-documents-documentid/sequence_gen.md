...
| B016 | `MemoRagService.getBenchmarkDocumentManifest` | `tenantId` が存在しない、または偽である | `apps/api/src/rag/memorag-service.ts:864 (MemoRagService.getBenchmarkDocumentManifest)` |
