...
# POST /admin/aliases/{aliasId}/update メッセージ仕様
...
| M011 | HTTP 実装応答 | `404` | Alias not found | `alias` が存在しない、または偽である | `apps/api/src/routes/admin-routes.ts:435 (POST /admin/aliases/{aliasId}/update handler)` |
