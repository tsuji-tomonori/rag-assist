...
| 5 | `MemoRagService.getResourceGroupMembershipState` | Service | service の resource group membership service 処理を呼び出す。 | `this.resourceGroupMembershipService()` | `apps/api/src/rag/memorag-service.ts:541 (MemoRagService.getResourceGroupMembershipState)` |
| 6 | `MemoRagService.getResourceGroupMembershipState` | Service | service の get state 処理を呼び出す。 | `this.resourceGroupMembershipService().getState(actor, groupId)` | `apps/api/src/rag/memorag-service.ts:541 (MemoRagService.getResourceGroupMembershipState)` |
