...
- 実装 route: `apps/api/src/routes/admin-routes.ts:511 (POST /admin/aliases/{aliasId}/disable)`
...
| `403` | 必要 permission (rag:alias:disable:group) または条件付き permission を満たさない場合。 | `{"error":"Forbidden"}` |
