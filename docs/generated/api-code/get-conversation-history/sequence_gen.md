...
| 4 | `MemoRagService.listConversationHistory` | Store | `this.deps.conversationHistoryStore` に対して list を実行する。 | `this.deps.conversationHistoryStore.list(ownerKey)` | `apps/api/src/rag/memorag-service.ts:4142 (MemoRagService.listConversationHistory)` |
| 5 | `MemoRagService.listConversationHistory` | Store | `this.deps.favoriteStore` に対して list を実行する。 | `this.deps.favoriteStore.list(ownerKey)` | `apps/api/src/rag/memorag-service.ts:4143 (MemoRagService.listConversationHistory)` |
