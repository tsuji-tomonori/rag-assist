...
# GET /conversation-history Unit Test仕様
...
| Case | シナリオ | 期待観点 | 根拠 |
| --- | --- | --- | --- |
| TC001 | 正常系 | 会話履歴一覧を取得する が成功 response を返す。 | `apps/api/src/routes/conversation-history-routes.ts:21 (GET /conversation-history handler)` |
