...
| M006 | HTTP 実装応答 | `404` | Conversation history not found | `item` が存在しない、または偽である | `apps/api/src/routes/conversation-history-routes.ts:45 (GET /conversation-history/{id} handler)` |
