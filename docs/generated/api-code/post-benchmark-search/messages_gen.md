...
| M007 | 例外 | `400` | Benchmark search user override is not supported | 当該処理へ到達した場合 | `apps/api/src/routes/benchmark-routes.ts:22 (benchmarkSearchUser)` |
