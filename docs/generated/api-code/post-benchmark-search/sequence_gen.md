...
| 5 | `MemoRagService.search` | Service | service の assert search scope readable 処理を呼び出す。 | `this.assertSearchScopeReadable(user, input.scope)` | `apps/api/src/rag/memorag-service.ts:2850 (MemoRagService.search)` |
