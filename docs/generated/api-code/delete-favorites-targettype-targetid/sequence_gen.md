...
| 5 | `MemoRagService.deleteFavorite` | Service | service の delete 処理を呼び出す。 | `this.favoriteService.delete(subject, targetType, targetId, tenantId)` | `apps/api/src/rag/memorag-service.ts:4206 (MemoRagService.deleteFavorite)` |
