...
# DELETE /favorites/{targetType}/{targetId} Unit Test仕様
...
| Case | シナリオ | 期待観点 | 根拠 |
| --- | --- | --- | --- |
| TC001 | 正常系 | お気に入り shortcut を削除する が成功 response を返す。 | `apps/api/src/routes/favorite-routes.ts:62 (DELETE /favorites/{targetType}/{targetId} handler)` |
