...
# POST /admin/users/{userId}/unsuspend メッセージ仕様
...
| M006 | HTTP 実装応答 | `404` | User not found | `user` が存在しない、または偽である | `apps/api/src/routes/admin-routes.ts:190 (POST /admin/users/{userId}/unsuspend handler)` |
