...
| 5 | `MemoRagService.unsuspendManagedUser` | Service | service の update managed user status 処理を呼び出す。 | `this.updateManagedUserStatus(actor, userId, "active")` | `apps/api/src/rag/memorag-service.ts:2158 (MemoRagService.unsuspendManagedUser)` |
