...
- 実装 route: `apps/api/src/routes/admin-routes.ts:295 (POST /admin/users/{userId}/unsuspend)`
...
| `403` | 必要 permission (user:unsuspend) または条件付き permission を満たさない場合。 | `{"error":"Forbidden"}` |
