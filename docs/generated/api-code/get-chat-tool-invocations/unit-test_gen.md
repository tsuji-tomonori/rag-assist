...
# GET /chat-tool-invocations Unit Test仕様
...
| Case | シナリオ | 期待観点 | 根拠 |
| --- | --- | --- | --- |
| TC001 | 正常系 | チャット tool invocation 監査一覧を取得する が成功 response を返す。 | `apps/api/src/routes/chat-routes.ts:179 (GET /chat-tool-invocations handler)` |
