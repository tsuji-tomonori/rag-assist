...
| M006 | 例外 | `-` | `Unsupported favorite target type: ${input.targetType}` | favorite target resolver implemented の判定結果が真ではない | `apps/api/src/favorites/favorite-service.ts:30 (FavoriteService.save)` |
