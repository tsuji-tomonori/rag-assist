...
| 5 | `MemoRagService.saveFavorite` | Service | service の save 処理を呼び出す。 | `this.favoriteService.save(user, input)` | `apps/api/src/rag/memorag-service.ts:4163 (MemoRagService.saveFavorite)` |
