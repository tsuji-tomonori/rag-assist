...
| 2 | `favoriteTargetResolverImplemented` | favorite target resolver implemented の実装処理を担当する。 | `apps/api/src/rag/memorag-service.ts:6353 (favoriteTargetResolverImplemented)` |
| 2 | `tenantPartitionedOwnerKey` | tenant partitioned owner key の実装処理を担当する。 | `apps/api/src/rag/memorag-service.ts:5971 (tenantPartitionedOwnerKey)` |
