...
| 5 | `MemoRagService.updateDocumentShare` | Service | service の get manifest 処理を呼び出す。 | `this.getManifest(documentId, authoritativeActorTenantId(actor))` | `apps/api/src/rag/memorag-service.ts:1282 (MemoRagService.updateDocumentShare)` |
...
| B006 | `MemoRagService.updateDocumentShare` | can share document の判定結果が真ではない | `apps/api/src/rag/memorag-service.ts:1285 (MemoRagService.updateDocumentShare)` |
