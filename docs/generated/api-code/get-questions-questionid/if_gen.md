...
# GET /questions/{questionId} IF仕様

- 実装 route: `apps/api/src/routes/question-routes.ts:69 (GET /questions/{questionId})`
...
補足:
- 問い合わせ作成者本人は answer:edit がなくても実行できます。その場合 internalMemo は返しません。
