...
| 5 | `MemoRagService.createBenchmarkRun` | Service | service の create 処理を呼び出す。 | `this.benchmarkRunCreationService.create(user, input)` | `apps/api/src/rag/memorag-service.ts:4588 (MemoRagService.createBenchmarkRun)` |
