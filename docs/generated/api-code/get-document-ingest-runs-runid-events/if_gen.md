...
- 実装 route: `apps/api/src/routes/document-routes.ts:624 (GET /document-ingest-runs/{runId}/events)`
...
補足:
- chat:read:own は自分が作成した run のみ購読できます。BENCHMARK_RUNNER は自分が作成した benchmark seed run のみ購読できます。
