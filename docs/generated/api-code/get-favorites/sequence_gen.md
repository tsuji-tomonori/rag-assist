...
| 4 | `MemoRagService.listFavorites` | Service | service の list 処理を呼び出す。 | `this.favoriteService.list(user)` | `apps/api/src/rag/memorag-service.ts:4219 (MemoRagService.listFavorites)` |
