...
# GET /benchmark-runs/{runId}/logs メッセージ仕様
...
| M006 | HTTP 実装応答 | `404` | Benchmark CodeBuild logs not found | `download` が存在しない、または偽である | `apps/api/src/routes/benchmark-routes.ts:234 (GET /benchmark-runs/{runId}/logs handler)` |
