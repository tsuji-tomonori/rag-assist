...
| 5 | `MemoRagService.getBenchmarkCodeBuildLogText` | External | `this.benchmarkRunQueryService` へ get code build log text を実行する。 | `this.benchmarkRunQueryService.getCodeBuildLogText(actor, runId)` | `apps/api/src/rag/memorag-service.ts:4718 (MemoRagService.getBenchmarkCodeBuildLogText)` |
