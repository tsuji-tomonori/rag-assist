...
| favorites | AC-SQ016-007 | pass | blocked | blocked | required E2E-UI-STATE-001に加え、Chromium／Firefox／WebKit required E2E-UI-CROSS-BROWSER-STATE-004でloading→500→retry→confirmed emptyとHTTP 403を区別し、false zero、empty、private detail露出を防ぐ。E2E-UI-LAYOUT-STRESS-001で確認済み0件も検証。manual evidenceは未実施 |
