...
| admin alias governance/URL/cursor/reflow automation is implemented; shared security audit projection、usage/cost integrity、manual a11y remain | `FR-096`〜`FR-098`, `SQ-016` | `tasks/do/20260714-1011-admin-ui-governance-quality.md`, `tasks/todo/20260714-1011-admin-access-audit-state.md`, `tasks/todo/20260714-1011-admin-usage-cost-integrity.md`, `tasks/todo/20260714-issue-345-manual-a11y-evidence.md` |
