...
| admin alias governance/URL/cursor/reflow automation と shared security audit projection は実装済み。usage/cost integrity は active cutover 前の shadow 実装、manual a11y は未実施 | `FR-027`, `FR-096`〜`FR-098`, `SQ-016` | `tasks/done/20260714-1011-admin-ui-governance-quality.md`, `tasks/done/20260714-1011-admin-access-audit-state.md`, `tasks/do/20260714-1011-admin-usage-cost-integrity.md`, `tasks/todo/20260714-issue-345-manual-a11y-evidence.md` |
