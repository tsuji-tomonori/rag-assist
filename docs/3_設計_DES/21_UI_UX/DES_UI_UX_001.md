...
| `favorites` | `/?view=favorites` | no `AppRoutes` guard; data uses own-history boundary | all signed-in personas | `JOB-UI-FAVORITES`: inspect and resume favorited own conversation | `FR-028`, `FR-094`, `FR-095`, `FR-097`, `SQ-016`; `AC-FR028-004`, `AC-FR094-002` | `E2E-VIEW-FAVORITES-001`, `E2E-UI-NAV-001`, `E2E-UI-ROUTE-001`, `E2E-UI-STATE-001` | partial: mobile reachability、browser-history restoration、required state/false-zero evidence exist; favorite resume journey and manual evidence remain |
...
- `E2E-UI-STATE-001` is part of the required Chromium UI quality gate and exercises history / favorites / assignee initial loading/500/confirmed-empty recovery、actual HTTP 403、benchmark run/suite part loading/500/confirmed-empty recovery and HTTP 403、admin partial recovery、source/as-of stale recovery. Primitive/controller/component tests cover all state variants and false-zero rules; the other three AppViews remain blocked in the cross-screen content-state matrix until feature evidence exists.
