...
| --- | --- | --- |
| 1. 文書・知識ベース管理 | `FR-001`, `FR-002`, `FR-007`, `FR-008`, `FR-020`, `FR-038`, `FR-041` | 文書登録、QA利用可能化、文書削除、多抽象度メモリ生成、非同期文書取り込み、スコープ付き資料グループ管理 |
...
| 3. RAG検索品質制御 | `FR-016`, `FR-017`, `FR-018`, `FR-023`, `FR-026`, `FR-045` | 検索計画・行動追跡、Hybrid retrieval、検索結果統合、検索結果評価、検索alias管理、retrieval adoption gate |
...
- `1_要求_REQ/11_製品要求_PRODUCT/01_機能要求_FUNCTIONAL/01_文書・知識ベース管理/07_スコープ付き資料グループ管理/REQ_FUNCTIONAL_041.md` (`FR-041`)
...
- `1_要求_REQ/11_製品要求_PRODUCT/01_機能要求_FUNCTIONAL/08_認証・認可・管理・監査/06_3層認可モデル/REQ_FUNCTIONAL_052.md` (`FR-052`, planning)
...
| `FR-021`, `FR-031`, `FR-032`, `FR-033`, `FR-034`, `FR-035`, `FR-036`, `FR-037`, `NFR-011`, `NFR-013` | `ASR-SEC-001` | `ARC_ADR_001` | `DES_HLD_001`, `DES_DLD_007`, `DES_API_001`, `DES_DATA_001` | `REQ_ACCEPTANCE_001` |
...
| `TC-003` | `ASR-SEC-001`, `ASR-OPER-001` | `ARC_ADR_005` | CloudFront / API middleware / WebSocket ticket design TBD | `REQ_TECHNICAL_CONSTRAINT_003` |
