...
| docs/spec/2026-chapter-spec.md 4A/4B, docs/spec/gap-phase-f.md | GAP-016 | TASK-F-PRE-GAP | AC-DOCS-001 | E2E-DOCS-001 | OP-048, EXP-048 | FR-003, FR-004, FR-005, FR-014, FR-015, FR-016, FR-045, FR-049 | SPEC-RAG-001, SPEC-RAG-002, docs/spec/gap-phase-f.md | confirmed | Phase F-pre で chat-orchestration nodes と toolId / multi-turn 構造の差分、踏襲すべき既存挙動、後続 `F-chat-tool-registry-multiturn` の scope / scope-out を記録。 |
