  ...
  constructor(scope: Construct, id: string, props?: MemoRagMvpStackProps) {
    ...
    new s3deploy.BucketDeployment(this, "DeployBenchmarkDatasets", {
      sources: [
        ...
        s3deploy.Source.data("mtrag-v1.jsonl", fs.readFileSync(path.join(__dirname, "../../benchmark/dataset.mtrag.sample.jsonl"), "utf-8")),
        s3deploy.Source.data("chatrag-bench-v1.jsonl", fs.readFileSync(path.join(__dirname, "../../benchmark/dataset.chatrag-bench.sample.jsonl"), "utf-8"))
      ],
        ...
        phases: {
          ...
          pre_build: {
            commands: [
              ...
              "if [ \"$SUITE_ID\" = \"standard-agent-v1\" ] || [ \"$SUITE_ID\" = \"smoke-agent-v1\" ] || [ \"$SUITE_ID\" = \"clarification-smoke-v1\" ] || [ \"$SUITE_ID\" = \"mtrag-v1\" ] || [ \"$SUITE_ID\" = \"chatrag-bench-v1\" ] || [ \"$SUITE_ID\" = \"search-standard-v1\" ] || [ \"$SUITE_ID\" = \"search-smoke-v1\" ]; then export BENCHMARK_CORPUS_DIR=benchmark/corpus/standard-agent-v1; export BENCHMARK_CORPUS_SUITE_ID=standard-agent-v1; fi",
