...
| ドキュメント | documents | / (client-state) | [ドキュメント](web-features/documents.md) | DocumentWorkspace | canManageDocuments | 管理者設定へ戻る、フォルダを検索、フォルダを絞り込み、すべてのドキュメント、社内規定、新規フォルダ ほか 28 件 | confirmed |
...
- 主要操作: 管理者設定へ戻る、フォルダを検索、フォルダを絞り込み、すべてのドキュメント、社内規定、新規フォルダ、共有設定を開く、名前を変更、移動、前のページ ほか 24 件
