...
- 主要操作: 管理者設定へ戻る、文書詳細を閉じる、この資料に質問する、再インデックス、削除、共有フォルダ / 選択してください / 共有 Cognito group / 既存 shared group 候補 / 追加: / 削除: / 変更なし: /…、共有フォルダ / 選択してください、shareGroupId || selectedGroupId、選択してください、共有 Cognito group ほか 59 件
