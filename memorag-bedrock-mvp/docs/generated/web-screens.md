...
| ドキュメント | documents | / (client-state) | [ドキュメント](web-features/documents.md) | DocumentWorkspace | canManageDocuments | 管理者設定へ戻る、共有フォルダ / 選択してください / 共有 Cognito group / 共有更新、共有フォルダ / 選択してください、shareGroupId \|\| selectedGroupId、選択してください、共有 Cognito group ほか 17 件 | confirmed |
...
- 主要操作: 管理者設定へ戻る、共有フォルダ / 選択してください / 共有 Cognito group / 共有更新、共有フォルダ / 選択してください、shareGroupId || selectedGroupId、選択してください、共有 Cognito group、Cognito group をカンマ区切りで入力、共有更新、保存先フォルダ / 保存先を選択 / アップロード、保存先フォルダ / 保存先を選択 ほか 13 件
