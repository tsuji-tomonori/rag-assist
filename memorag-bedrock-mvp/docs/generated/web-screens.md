...
| ドキュメント | documents | / (client-state) | [ドキュメント](web-features/documents.md) | DocumentWorkspace | canManageDocuments | 管理者設定へ戻る、文書詳細を閉じる、再インデックス、削除、共有フォルダ / 選択してください / 共有 Cognito group / 追加: / 削除: / 変更なし: / 共有更新、共有フォルダ / 選択してください ほか 54 件 | confirmed |
...
- 主要操作: 管理者設定へ戻る、文書詳細を閉じる、再インデックス、削除、共有フォルダ / 選択してください / 共有 Cognito group / 追加: / 削除: / 変更なし: / 共有更新、共有フォルダ / 選択してください、shareGroupId || selectedGroupId、選択してください、共有 Cognito group、Cognito group をカンマ区切りで入力 ほか 50 件
