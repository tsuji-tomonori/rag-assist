...
- L2主機能群: `2.6 確認質問・曖昧性解消`
- L3要件: `FR-029`
- 関連カテゴリ: `3. RAG検索品質制御`, `4. 回答検証・ガードレール`, `7. 評価・debug・benchmark`
...
- AC-FR029-007: benchmark は `clarificationNeedF1`、`overClarificationRate`、`optionHitRate`、`missingSlotHitRate`、`postClarificationAccuracy`、`postClarificationTaskLatencyMs` を summary metrics として出力できること。
