...
| --- | --- | --- |
| 1. 文書・知識ベース管理 | `FR-001`, `FR-002`, `FR-007`, `FR-008`, `FR-020`, `FR-038` | 文書登録、QA利用可能化、文書削除、多抽象度メモリ生成、非同期文書取り込み |
| 2. チャットQA・根拠提示・回答不能制御 | `FR-003`, `FR-004`, `FR-005`, `FR-006`, `FR-009`, `FR-029`, `FR-041`, `FR-042` | 質問入力、根拠提示、回答不能表示、回答挙動調整、統合チャットUI、確認質問・曖昧性解消、チャットUI操作性 |
| 3. RAG検索品質制御 | `FR-016`, `FR-017`, `FR-018`, `FR-023`, `FR-026`, `FR-044` | 検索計画・行動追跡、Hybrid retrieval、検索結果統合、検索結果評価、検索alias管理、retrieval adoption gate |
| 4. 回答検証・ガードレール | `FR-014`, `FR-015` | 回答前ガード、回答後検証 |
| 5. 会話履歴・お気に入り | `FR-022`, `FR-028`, `FR-030`, `FR-043` | 会話履歴管理、お気に入り管理、会話履歴検索、履歴表示順 |
| 6. 問い合わせ・人手対応 | `FR-021`, `FR-031`, `FR-032`, `FR-033`, `FR-034`, `FR-035`, `FR-036`, `FR-037` | 問い合わせ管理 |
| 7. 評価・debug・benchmark | `FR-010`, `FR-011`, `FR-012`, `FR-013`, `FR-019`, `FR-039`, `FR-040`, `FR-045`, `FR-046`, `FR-047` | 実行履歴確認、実行結果ダウンロード、UI非依存評価、外部連携仕様、benchmark 指標、benchmark corpus seed、benchmark corpus 隔離、debug trace artifact、dataset adapter、benchmark 実行追跡 |
...
- `1_要求_REQ/11_製品要求_PRODUCT/01_機能要求_FUNCTIONAL/02_チャットQA・根拠提示・回答不能制御/07_チャットUI操作性/REQ_FUNCTIONAL_041.md` (`FR-041`)
- `1_要求_REQ/11_製品要求_PRODUCT/01_機能要求_FUNCTIONAL/02_チャットQA・根拠提示・回答不能制御/07_チャットUI操作性/REQ_FUNCTIONAL_042.md` (`FR-042`)
- `1_要求_REQ/11_製品要求_PRODUCT/01_機能要求_FUNCTIONAL/05_会話履歴・お気に入り/04_履歴表示順/REQ_FUNCTIONAL_043.md` (`FR-043`)
- `1_要求_REQ/11_製品要求_PRODUCT/01_機能要求_FUNCTIONAL/03_RAG検索品質制御/06_retrieval_adoption_gate/REQ_FUNCTIONAL_044.md` (`FR-044`)
- `1_要求_REQ/11_製品要求_PRODUCT/01_機能要求_FUNCTIONAL/07_評価・debug・benchmark/08_debug_trace_artifact/REQ_FUNCTIONAL_045.md` (`FR-045`)
- `1_要求_REQ/11_製品要求_PRODUCT/01_機能要求_FUNCTIONAL/07_評価・debug・benchmark/09_dataset_adapter/REQ_FUNCTIONAL_046.md` (`FR-046`)
- `1_要求_REQ/11_製品要求_PRODUCT/01_機能要求_FUNCTIONAL/07_評価・debug・benchmark/10_benchmark実行追跡/REQ_FUNCTIONAL_047.md` (`FR-047`)
...
| `FR-041`, `FR-042`, `FR-043`, `SQ-004` | `ASR-TRUST-001` | `ARC_ADR_001` | `DES_HLD_001`, `DES_API_001` | 各要求の受け入れ条件 |
| `FR-044`, `SQ-003` | `ASR-RETRIEVAL-001`, `ASR-GUARD-001` | `ARC_ADR_001` | `DES_DLD_001`, `DES_DLD_002`, `DES_DATA_001` | `SQ-001`, 各要求の受け入れ条件 |
| `FR-045`, `NFR-015` | `ASR-SEC-001`, `ASR-EVAL-001` | `ARC_ADR_001` | `DES_API_001`, `DES_DATA_001` | `REQ_FUNCTIONAL_045`, `REQ_NON_FUNCTIONAL_015` |
| `FR-046`, `FR-047`, `SQ-002` | `ASR-EVAL-001` | `ARC_ADR_001` | `DES_DATA_001`, `DES_API_001` | `REQ_FUNCTIONAL_046`, `REQ_FUNCTIONAL_047`, `SQ-002` |
