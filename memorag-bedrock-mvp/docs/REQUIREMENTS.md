...
| --- | --- | --- |
| 1. 文書・知識ベース管理 | `FR-001`, `FR-002`, `FR-007`, `FR-008`, `FR-020`, `FR-031` | 文書登録、QA利用可能化、文書削除、多抽象度メモリ生成、非同期文書取り込み |
...
| 7. 評価・debug・benchmark | `FR-010`, `FR-011`, `FR-012`, `FR-013`, `FR-019`, `FR-032`, `FR-033` | 実行履歴確認、実行結果ダウンロード、UI非依存評価、外部連携仕様、benchmark 指標、benchmark corpus seed、benchmark corpus 隔離 |
...
- `1_要求_REQ/11_製品要求_PRODUCT/01_機能要求_FUNCTIONAL/01_文書・知識ベース管理/06_非同期文書取り込み/REQ_FUNCTIONAL_031.md` (`FR-031`)
- `1_要求_REQ/11_製品要求_PRODUCT/01_機能要求_FUNCTIONAL/07_評価・debug・benchmark/06_benchmark_corpus_seed/REQ_FUNCTIONAL_032.md` (`FR-032`)
- `1_要求_REQ/11_製品要求_PRODUCT/01_機能要求_FUNCTIONAL/07_評価・debug・benchmark/07_benchmark_corpus隔離/REQ_FUNCTIONAL_033.md` (`FR-033`)
...
| `FR-019`, `FR-032`, `FR-033`, `SQ-001`, `SQ-002` | `ASR-EVAL-001` | `ARC_ADR_001` | `DES_DATA_001`, `DES_API_001` | `REQ_ACCEPTANCE_001` |
...
| `FR-021`, `NFR-011`, `NFR-013` | `ASR-SEC-001` | `ARC_ADR_001` | `DES_API_001`, `DES_DATA_001` | `REQ_ACCEPTANCE_001` |
...
| `FR-031` | `ASR-OPER-001` | `ARC_ADR_001` | `DES_DATA_001`, `DES_API_001` | `REQ_FUNCTIONAL_031` |
