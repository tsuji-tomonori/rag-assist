...
| 機能要求 | `1_要求_REQ/11_製品要求_PRODUCT/01_機能要求_FUNCTIONAL/` | 文書登録、質問応答、根拠提示、担当者問い合わせ、会話履歴、debug trace、benchmark |
...
| 実装速度 vs 検索基盤の汎用性 | OpenSearch 互換や Athena 直検索を通常検索の主経路にすると MVP の焦点がぼやける | `TC-001` と `TC-002` により S3 Vectors、軽量 retriever、Athena の補助用途に制約する |
...
| `TC-001`, `TC-002` | `ASR-RETRIEVAL-001` | `ARC_ADR_001` | `DES_DLD_002`, `DES_DLD_003` | `SQ-001` |
