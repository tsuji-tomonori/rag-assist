...
id: 2
event: final
data: {"answer":"...", "isAnswerable":true, "citations":[]}
```
...
| 非同期チャット event 購読 | `GET /chat-runs/{runId}/events` | REST API Cognito authorizer + run owner または `chat:admin:read_all` | `CHAT_USER`, `SYSTEM_ADMIN` |
