...
export async function analyzeInput(state: ChatOrchestrationState): Promise<ChatOrchestrationUpdate> {
...
function buildEffectiveQuestion(state: ChatOrchestrationState): string {
