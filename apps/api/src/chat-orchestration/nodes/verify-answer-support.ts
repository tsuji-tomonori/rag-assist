...
import { NO_ANSWER, type AnswerSupportJudgement, type ChatOrchestrationState, type ChatOrchestrationUpdate } from "../state.js"
...
export function createVerifyAnswerSupportNode(deps: Dependencies) {
  return async function verifyAnswerSupport(state: ChatOrchestrationState): Promise<ChatOrchestrationUpdate> {
...
async function repairUnsupportedAnswer(
  ...
  evidenceChunks: ChatOrchestrationState["selectedChunks"]
): Promise<ChatOrchestrationUpdate | undefined> {
...
function selectCitedChunks(state: ChatOrchestrationState): ChatOrchestrationState["selectedChunks"] {
...
function normalizeJudgement(parsed: SupportJson | undefined, state: ChatOrchestrationState, evidenceChunks: ChatOrchestrationState["selectedChunks"]): AnswerSupportJudgement {
...
function unsupported(reason: string, state: ChatOrchestrationState): AnswerSupportJudgement {
  return {
    supported: false,
...
function selectedComputedFacts(state: ChatOrchestrationState): ChatOrchestrationState["computedFacts"] {
...
function validChunkIds(ids: string[], chunks: ChatOrchestrationState["selectedChunks"]): string[] {
...
function chunksForUsedIds(ids: string[], chunks: ChatOrchestrationState["selectedChunks"]): ChatOrchestrationState["selectedChunks"] {
