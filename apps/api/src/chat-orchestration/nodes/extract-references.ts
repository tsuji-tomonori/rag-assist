import type { ChatOrchestrationState, ChatOrchestrationUpdate, ReferenceTarget } from "../state.js"
...
export async function extractReferences(state: ChatOrchestrationState): Promise<ChatOrchestrationUpdate> {
