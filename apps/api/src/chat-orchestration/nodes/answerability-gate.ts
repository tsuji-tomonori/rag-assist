...
function computedFactAnswerabilityReason(state: ChatOrchestrationState): ChatOrchestrationState["answerability"]["reason"] {
...
function formatComputedFactAssessment(fact: ChatOrchestrationState["computedFacts"][number]): string {
...
function estimateRequiredFactCoverage(state: ChatOrchestrationState, chunks: SelectedChunk[]): { ok: boolean; confidence: number; sentenceAssessments: SentenceAssessment[] } {
