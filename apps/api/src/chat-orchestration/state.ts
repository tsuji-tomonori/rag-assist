...
export const ChatOrchestrationStateSchema = z.object({
  runId: z.string(),
  question: z.string(),
...
export type ChatOrchestrationState = z.infer<typeof ChatOrchestrationStateSchema>
export type ChatOrchestrationUpdate = Partial<Omit<ChatOrchestrationState, "trace">> & {
  trace?: z.infer<typeof DebugStepSchema> | Array<z.infer<typeof DebugStepSchema>>
}
export type AnswerabilityReason = ChatOrchestrationState["answerability"]["reason"]
