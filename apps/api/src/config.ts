...
export const config = {
  ...
  claudeCodeModelIds: csvEnv("CLAUDE_CODE_MODEL_IDS"),
  claudeCodeTimeoutMs: intEnv("CLAUDE_CODE_TIMEOUT_MS", 30 * 60 * 1000),
  codexCommand: process.env.CODEX_COMMAND ?? "",
  codexModelIds: csvEnv("CODEX_MODEL_IDS"),
  codexTimeoutMs: intEnv("CODEX_TIMEOUT_MS", 30 * 60 * 1000),
  openCodeCommand: process.env.OPENCODE_COMMAND ?? "",
  openCodeModelIds: csvEnv("OPENCODE_MODEL_IDS"),
  openCodeTimeoutMs: intEnv("OPENCODE_TIMEOUT_MS", 30 * 60 * 1000),
