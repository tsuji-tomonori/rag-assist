...
const traceByRequirement: Record<string, string[]> = {
  ...
  "FR-097": ["apps/web/src/app/hooks/useAppShellState.ts", "apps/web/src/app/hooks/useAppShellState.test.ts", "apps/web/src/app/routing/appRoute.ts", "apps/web/src/app/routing/appRoute.test.ts", "apps/web/src/features/documents/components/DocumentWorkspace.tsx", "apps/web/src/features/documents/components/DocumentWorkspace.test.tsx", "tools/web-inventory/ui-traceability.json", "tasks/done/20260714-issue-345-url-history-routing.md", "tasks/todo/20260714-issue-345-document-workspace-context.md"],
  ...
  "NFR-017": ["tools/web-inventory/ui-traceability.json", "tasks/do/20260714-issue-345-ui-language-primitives.md"],
