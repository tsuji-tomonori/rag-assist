...
const traceByRequirement: Record<string, string[]> = {
  ...
  "FR-019": ["benchmark/run.ts", "infra/scripts/update-benchmark-run-metrics.mjs", "apps/api/src/rag/quality-control/production-rag-observation-producer.ts", "benchmark/run.test.ts", "infra/test/update-benchmark-run-metrics.test.ts", "apps/api/src/rag/production-rag-observation-producer.test.ts"],
  ...
  "SQ-001": ["benchmark/run.ts", "benchmark/run.test.ts", "apps/api/src/search/hybrid-search.test.ts"],
