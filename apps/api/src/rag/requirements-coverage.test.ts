...
const traceByRequirement: Record<string, string[]> = {
  ...
  "FR-018": ["apps/api/src/rag/online/retrieval/hybrid/hybrid-retriever.ts", "apps/api/src/rag/online/retrieval/request-time/search-evidence.ts", "apps/api/src/search/hybrid-search.test.ts", "apps/api/src/rag/__tests__/runtime-layout.test.ts"],
  "FR-019": ["benchmark/run.ts", "node-units.test.ts"],
  "FR-020": ["apps/api/src/rag/memorag-service.ts", "apps/api/src/rag/offline/pre-retrieval/ingestion/ingest-run.service.ts", "apps/api/src/rag/multi-abstraction-memory.test.ts", "apps/api/src/chat-orchestration/nodes/retrieve-memory.test.ts"],
  ...
  "FR-024": ["apps/web/src/features/admin/components/AdminWorkspace.tsx", "apps/web/src/features/admin/components/AdminWorkspace.test.tsx", "apps/api/src/authorization.test.ts", "apps/api/src/security/access-control-policy.test.ts"],
  ...
  "FR-053": ["apps/api/src/openapi-runtime-source.test.ts", "apps/api/src/openapi-doc-quality.test.ts", "apps/api/src/validate-openapi-docs.ts", ".github/workflows/memorag-ci.yml", "tasks/todo/20260713-2302-api-lifecycle-common-middleware.md"],
  "FR-054": [".github/workflows/deploy.yml", "infra/test/memorag-mvp-stack.test.ts", "tasks/todo/20260716-2141-fr-054-deploy-evidence-completion.md"],
  "FR-055": ["apps/api/src/app.ts", "apps/api/src/routes/chat-routes.ts", "apps/api/src/routes/document-routes.ts", "apps/api/src/contract/chat-run-events-stream.test.ts", "apps/api/src/security/access-control-policy.test.ts", "apps/api/src/worker-contract.test.ts", "apps/api/src/benchmark-run-authorization-worker.test.ts", "tasks/todo/20260713-2302-api-lifecycle-common-middleware.md"],
  ...
  "FR-060": ["apps/api/src/security/tenant-partition.ts", "apps/api/src/rag/_shared/storage/tenant-artifacts.ts", "apps/api/src/documents/document-permission-service.ts", "apps/api/src/security/tenant-partition.test.ts", "apps/api/src/adapters/tenant-scoped-run-stores.test.ts", "apps/api/src/adapters/dynamodb-tenant-run-stores.test.ts", "apps/api/src/routes/benchmark-tenant-boundary.test.ts", "apps/api/src/rag/embedding-cache-tenant.test.ts", "apps/api/src/rag/tenant-artifact-partition.test.ts", "apps/api/src/documents/document-permission-service.test.ts"],
  ...
  "FR-066": ["apps/api/src/rag/offline/pre-retrieval/admission/source-governance-approval-service.ts", "apps/api/src/documents/document-lifecycle-mutation-coordinator.ts", "apps/api/src/folders/folder-archive-service.ts", "apps/api/src/rag/_shared/security/production-revocation-cleanup.ts", "apps/api/src/rag/offline/pre-retrieval/admission/source-governance-approval-service.test.ts", "apps/api/src/documents/document-lifecycle-mutation-coordinator.test.ts", "apps/api/src/folders/folder-archive-service.test.ts", "apps/api/src/rag/_shared/security/production-revocation-cleanup.test.ts"],
  ...
  "FR-068": ["apps/api/src/rag/offline/pre-retrieval/admission/source-admission.ts", "apps/api/src/rag/offline/pre-retrieval/admission/source-governance-approval-service.ts", "apps/api/src/rag/_shared/security/current-rag-eligibility.ts", "apps/api/src/rag/_shared/publication/staged-publication-coordinator.ts", "apps/api/src/rag/admission-lifecycle.test.ts", "apps/api/src/rag/offline/pre-retrieval/admission/source-governance-approval-service.test.ts", "apps/api/src/rag/staged-publication.test.ts"],
  ...
  "NFR-012": ["apps/api/src/security/public-resource-response.ts", "apps/api/src/security/public-resource-response.test.ts", "apps/api/src/rag/online/retrieval/hybrid/hybrid-retriever.ts", "apps/api/src/search/hybrid-search.test.ts"],
