...
const traceByRequirement: Record<string, string[]> = {
  ...
  "FR-019": ["benchmark/run.ts", "benchmark/run.test.ts", "benchmark/metrics/quality.test.ts"],
  ...
  "FR-045": ["apps/api/src/rag/prompts.test.ts", "apps/api/src/chat-orchestration/nodes/node-units.test.ts", "benchmark/release-audit.test.ts", "docs/1_要求_REQ/11_製品要求_PRODUCT/01_機能要求_FUNCTIONAL/03_RAG検索品質制御/06_retrieval_adoption_gate/REQ_FUNCTIONAL_045.md"],
  ...
  "FR-067": [
    ...
    "apps/api/src/search/temporary-attachment-boundary.test.ts"
  ],
  ...
  "NFR-018": [".github/workflows/memorag-ci.yml", "apps/web/e2e/visual-regression.spec.ts", "tasks/do/20260714-issue-345-ui-automated-quality-gates.md", "tasks/todo/20260714-issue-345-manual-a11y-evidence.md"],
  ...
  "SQ-003": ["apps/api/src/rag/prompts.test.ts", "apps/api/src/chat-orchestration/nodes/node-units.test.ts", "benchmark/release-audit.test.ts", "docs/1_要求_REQ/11_製品要求_PRODUCT/11_非機能要求_NON_FUNCTIONAL/11_サービス品質制約_SERVICE_QUALITY/REQ_SERVICE_QUALITY_003.md"],
