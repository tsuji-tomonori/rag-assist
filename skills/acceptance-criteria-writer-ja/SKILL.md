...
- The `Candidate tasks` section of the task-scoped specification analysis report
...
Create or update the `Acceptance criteria` section of the task-scoped analysis report. When a requirement is approved, copy its criteria into that requirement's one canonical file under `docs/1_要求_REQ/`.
