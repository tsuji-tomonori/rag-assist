...
Create or update the `Report facts` section of the task-scoped `reports/working/YYYYMMDD-HHMM-<summary>-spec-analysis.md` file.
...
Create or update the `Candidate tasks` section of the same task-scoped analysis report. Approved implementation work must be written as atomic files in `tasks/todo/`.
