...
- The `E2E and non-UI scenarios` section of the task-scoped specification analysis report
...
Create or update the `Operation and expectation groups` section of the task-scoped analysis report. Integrate confirmed durable results into the corresponding canonical requirement or design file.
