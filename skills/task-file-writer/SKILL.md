...
- User / developer docs:
  - update root `README.md`, the relevant canonical REQ/ARC/DES file, generated OpenAPI targets, `docs/4_運用_OPS/21_監視_MONITORING/`, Taskfile, and deploy workflows when behavior, API, verification, environment variables, permissions, rollback, cost, or deployment changes
- PR body:
