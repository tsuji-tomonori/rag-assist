...
- The `Acceptance criteria` section of the task-scoped specification analysis report
...
Create or update the `E2E and non-UI scenarios` section of the task-scoped analysis report. Durable scenarios belong with the canonical requirement/acceptance file or the relevant automated test, not in a parallel specification tree.
