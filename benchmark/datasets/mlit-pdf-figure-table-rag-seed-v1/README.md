...
```bash
npm run prepare:mlit-pdf-figure-table-rag -w @memorag-mvp/benchmark
```

既定の出力先は次の通りです。

```text
.local-data/mlit-pdf-figure-table-rag-seed-v1/dataset.jsonl
.local-data/mlit-pdf-figure-table-rag-seed-v1/corpus/
```
