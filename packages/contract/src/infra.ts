...
export type ApiRuntimeEnv = {
  ...
  USAGE_EVENTS_TABLE_NAME: string
  USAGE_ACCOUNTING_MODE: string
  ...
  USE_LOCAL_USAGE_EVENT_STORE: BooleanEnv
  USAGE_PRICING_CATALOG_JSON: string
  ...
  BENCHMARK_EVALUATION_ENABLED: BooleanEnv
  BENCHMARK_EVALUATION_TENANT_ID: string
